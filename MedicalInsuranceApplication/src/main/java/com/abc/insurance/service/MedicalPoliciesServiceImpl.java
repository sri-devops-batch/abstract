...
public class MedicalPoliciesServiceImpl implements MedicalPoliciesService {
	...
	public MedicalPolicies addMedicalPolicies(MedicalPolicies medicalPolicies) throws Exception {
		MedicalPolicies savedMedicalPolicies =medicalPoliciesRepository.save(medicalPolicies);
		return  savedMedicalPolicies;
	}
	...
	@Override
	@Transactional
	public MedicalPolicies linkPolicies(MedicalPolicies medicalPolicies, MedicalInsurance medicalInsurance) {

		medicalPolicies.setMedicalInsurances(medicalInsurance); 
		return medicalPolicies;
	}

	@Override
	public List<MedicalPolicies> getAllMedicalPolicies() throws Exception {
